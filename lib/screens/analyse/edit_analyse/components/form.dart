...
import 'package:medilink_app/screens/analyse/edit_analyse/components/files.dart';
import 'package:medilink_app/screens/analyse/edit_analyse/edit_analyse_controller.dart';
...
TextFormField buildUnitsFormField(EditAnalyseController controller) {
  return TextFormField(
...
TextFormField buildReferenceRangeFormField(EditAnalyseController controller) {
  return TextFormField(
...
Row buildabnormalFlagFormField(EditAnalyseController controller) {
  return Row(
    children: [
      Expanded(
        flex: 2,
