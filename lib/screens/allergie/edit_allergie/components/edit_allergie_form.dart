...
import 'package:medilink_app/screens/allergie/edit_allergie/edit_allergie_controller.dart';
...
TextFormField buildTestFormField(EditAllergyController controller) {
...
TextFormField buildreactionFormField(EditAllergyController controller) {
  return TextFormField(
...
TextFormField buildtriggerFormField(EditAllergyController controller) {
  return TextFormField(
...
TextFormField buildNoteFormField(EditAllergyController controller) {
  return TextFormField(
...
DropdownButtonFormField<String?> buildOnsetFormField(
  ...
  String? defaultValue = controller.allergy.onset;
...
DropdownButtonFormField<String?> buildfollowupStatusFormField(
  ...
  String? defaultValue = controller.allergy.followupStatus;
