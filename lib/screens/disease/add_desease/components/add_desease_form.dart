...
import 'package:medilink_app/screens/disease/add_desease/add_desease_controller.dart';
import 'package:medilink_app/utils/constants.dart';

class AddDiseaseForm extends StatelessWidget {
  const AddDiseaseForm({super.key, required this.user});
  final User user;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AddDiseaseController>(
        init: AddDiseaseController(user: user),
        builder: (controller) {
          return Form(
...
Row buildfamilyHistoryFormField(AddDiseaseController controller) {
  return Row(
    children: [
      Expanded(
        flex: 2,
...
Row buildrecurrenceFormField(AddDiseaseController controller) {
  return Row(
    children: [
      Expanded(
        flex: 2,
...
TextFormField buildTestFormField(AddDiseaseController controller) {
...
TextFormField buildsymptomsFormField(AddDiseaseController controller) {
  return TextFormField(
...
TextFormField buildmedicationsFormField(AddDiseaseController controller) {
  return TextFormField(
...
DropdownButtonFormField<String?> buildseverityFormField(
  AddDiseaseController controller,
) {
